...
class hulunfechiSkeletonLoader extends StatefulWidget {
  final bool loading;
  final Widget child;
  ...
  const hulunfechiSkeletonLoader({
    Key? key,
  ...
  @override
  _hulunfechiSkeletonLoaderState createState() =>
      _hulunfechiSkeletonLoaderState();
}

class _hulunfechiSkeletonLoaderState<T> extends State<hulunfechiSkeletonLoader>
